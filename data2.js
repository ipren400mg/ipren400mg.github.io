  ...
  menuCategories: {
    ...
    varmratter: {
      ...
      items: [
        ...
        { num: '41', name: 'Wok med Szechuan chilipasta och grönsaker', price: 'Kyckling 135 kr · Biff 155 kr · Räkor 159 kr', desc: 'Kan göras glutenfri.', spicy: 1 },
        ...
        { num: 'NY3', name: '3Måltiders biff med chili', price: '155 kr', desc: 'Lättfriterad biff med färsk lök, paprika och purjolök i hemgjord stark chili- och sötsursås och soja.', spicy: 3 },
    ...
    thai: {
      title: 'Thairätter',
      items: [
        { num: '48', name: 'Padd graprao nua', price: 'Kyckling 135 kr · Biff 155 kr · Räkor 159 kr', desc: 'Wokad starkbasilikablad, gullök, bambuskott, morötter, paprika, broccoli, vit blomkål och champinjoner.', spicy: 3 },
        ...
        { num: '52', name: 'Thai Röd curry', price: 'Kyckling 135 kr · Biff 155 kr · Räkor 159 kr', desc: 'Rödcurry med bambuskott och paprika.' , spicy: 2},
        { num: '53', name: 'Pad Phrik Paw', price: 'Kyckling 135 kr · Biff 155 kr · Räkor 159 kr', desc: 'Thai chilipasta, grönsaker, vitlök, citronblad.' , spicy: 2},
        { num: '54', name: 'Pad Graphrad', price: 'Kyckling 135 kr · Biff 155 kr · Räkor 159 kr', desc: 'Ostronsås, chilipasta, grönsaker, vitlök, citronblad.', spicy: 4},
      ],
    },
